...
<img src="https://capsule-render.vercel.app/api?type=venom&color=0:000000,25:88CE02,55:FFD700,80:FF6B00,100:000000&height=250&section=header&text=🌴%20GTA%20VI&fontSize=96&fontColor=ffffff&fontAlignY=52&animation=fadeIn&stroke=88CE02&strokeWidth=3&desc=Cinematic%20Scroll-Driven%20Landing%20Page%20%7C%20GSAP%20%2B%20React%20%2B%20Tailwind&descSize=19&descAlignY=74&descColor=88CE02" />
...
<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&weight=900&size=21&pause=1000&color=88CE02&center=true&vCenter=true&width=950&height=55&lines=🌴+Scroll-Driven+Cinematic+UI+%7C+GSAP+ScrollTrigger;🎬+High-Fidelity+GTA+VI+Recreation+in+the+Browser;⚡+60+FPS+WebP+Optimised+%7C+Vite+%2B+React+19;🎭+Scoped+useGSAP+%7C+Memory-Safe+Animation+Lifecycle" alt="Typing SVG" />

<br/><br/>

<!-- ── Tech Badges ── -->
<a href="https://gta-vi-woad.vercel.app/" target="_blank">
  <img src="https://img.shields.io/badge/Live_Demo-gta--vi--woad.vercel.app-88CE02?style=for-the-badge&logo=vercel&logoColor=white" />
</a>
...
<img src="https://img.shields.io/badge/Assets-WebP_Optimised-FFD700?style=for-the-badge" />
<img src="https://img.shields.io/badge/Animation-60_FPS-88CE02?style=for-the-badge" />
<img src="https://img.shields.io/badge/License-MIT-FF6B00?style=for-the-badge" />

<br/>

<img src="https://img.shields.io/github/stars/salonyranjan/GTA-VI?style=for-the-badge&color=88CE02" />
<img src="https://img.shields.io/github/forks/salonyranjan/GTA-VI?style=for-the-badge&color=FFD700" />
<img src="https://img.shields.io/github/last-commit/salonyranjan/GTA-VI?style=for-the-badge&color=FF6B00" />
<img src="https://img.shields.io/badge/Status-Live-88CE02?style=for-the-badge" />
...
<a href="https://gta-vi-woad.vercel.app/"><img src="https://img.shields.io/badge/🌴_Launch_Experience-88CE02?style=for-the-badge&logoColor=black" /></a>
&nbsp;
<a href="#8--getting-started"><img src="https://img.shields.io/badge/📦_Quick_Setup-FFD700?style=for-the-badge&logoColor=black" /></a>
&nbsp;
<a href="#4--technical-implementation"><img src="https://img.shields.io/badge/🎬_Animation_Engine-FF6B00?style=for-the-badge" /></a>
&nbsp;
<a href="#10--roadmap"><img src="https://img.shields.io/badge/🗺️_Roadmap-88CE02?style=for-the-badge&logoColor=black" /></a>
...
<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&weight=700&size=15&pause=1000&color=88CE02&center=true&vCenter=true&width=800&height=38&lines=🌴+Hero+%7C+🏙️+Narrative+%7C+🎭+Transitions+%7C+🌅+Outro+Finale" alt="UI tagline" />
...
```mermaid
graph TD
    classDef core fill:#1a1a1a,stroke:#88CE02,stroke-width:2px,color:#fff;
    classDef section fill:#0a1a0a,stroke:#FFD700,stroke-width:2px,color:#fff;
    classDef engine fill:#1a0a0a,stroke:#FF6B00,stroke-width:2px,color:#fff;

    A[🖼️ Static Assets<br/>.webp images] --> B[⚡ GSAP Animation Engine]
    B --> C{⚛️ React Components}
    C --> D[🌴 Hero Section]
    C --> E[🏙️ Content Section]
    C --> F[🌅 Outro Section]
    D & E & F --> G[🌍 Vercel Edge Deploy]
...
```mermaid
graph LR
    User((👤 User Scroll)) -->|position delta| SC[📜 Native Scroll]
    SC -->|progress 0→1| ST[🎬 GSAP ScrollTrigger]

    subgraph "🌴 Hero Scene"
    ST -->|opacity + scale| HeroImg[🖼️ photo1.webp]
    end

    subgraph "🏙️ Content Sections"
    ST -->|stagger reveal| Text[📝 Text Elements]
    ST -->|parallax| ContentImg[🖼️ photo2–4.webp]
    end

    subgraph "🌅 Outro Finale"
    ST -->|fade out| FinalContent[📄 final-content]
    ST -->|rise in| FinalMsg[✨ final-message]
    end

    classDef scroll fill:#0a1a0a,stroke:#88CE02,stroke-width:2px,color:#fff;
    classDef section fill:#1a0a0a,stroke:#FFD700,stroke-width:2px,color:#fff;
    class User,SC,ST scroll;
    class HeroImg,Text,ContentImg,FinalContent,FinalMsg section;
```
...
sequenceDiagram
    ...
    participant SC as 📜 Scroll Engine
    participant ST as 🎬 ScrollTrigger
    participant TL as ⚡ GSAP Timeline
    participant DOM as 🖼️ DOM Elements

    Note over U,SC: Page Load
    U->>SC: Page mount
    SC->>ST: Initialise all triggers
    ST->>TL: Set initial states (immediateRender:false)
    TL-->>DOM: Elements locked in start positions

    Note over U,DOM: Scroll Interaction
    U->>SC: Scroll down
    SC->>ST: progress = 0.0 → 1.0
    ST->>TL: Scrub timeline to progress value
    TL->>DOM: Update transform + opacity
    DOM-->>U: Cinematic frame rendered at 60fps ✅

    Note over U,DOM: Outro Sequence
    U->>SC: Reach outro trigger zone
    ST->>TL: Run dual-layer timeline
    TL->>DOM: final-content fades to opacity 0
    TL->>DOM: final-message rises to opacity 1
    DOM-->>U: Cinematic finale complete 🌴
```
...
<p>
  ...
  <img src="https://img.shields.io/badge/ScrollTrigger-88CE02?style=for-the-badge&logo=greensock&logoColor=black" />
  <img src="https://img.shields.io/badge/@gsap/react-useGSAP-1a1a1a?style=for-the-badge&logo=greensock&logoColor=88CE02" />
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/WebP_Assets-FFD700?style=for-the-badge" />
</p>
...
| ![Chrome](https://img.shields.io/badge/Chrome-4285F4?style=flat&logo=googlechrome&logoColor=white) | latest | Best GSAP ScrollTrigger performance |
...
graph LR
    ...
    style Edge fill:#88CE02,color:#000
...
<table style="border:none;">
  <tr>
    <td align="center" style="border:none;" width="160">
      <img src="https://github.com/salonyranjan.png" width="145" style="border-radius:50%; border:3px solid #88CE02; box-shadow:0 0 25px #88CE02, 0 0 50px #FFD70040;" alt="Salony Ranjan" />
    </td>
    <td style="border:none; padding-left:22px;">
      ...
      &nbsp;
      <a href="https://vertex-flow-phi.vercel.app/"><img src="https://img.shields.io/badge/Portfolio-88CE02?style=for-the-badge&logo=react&logoColor=black" /></a>
    </td>
  </tr>
</table>
...
<a href="https://github.com/salonyranjan/GTA-VI/stargazers"><img src="https://img.shields.io/badge/⭐_Star_This_Repo-88CE02?style=for-the-badge&logo=github&logoColor=black" /></a>
&nbsp;
<a href="https://github.com/salonyranjan/GTA-VI/fork"><img src="https://img.shields.io/badge/🍴_Fork_&_Build-FFD700?style=for-the-badge&logo=github&logoColor=black" /></a>
&nbsp;
<a href="https://gta-vi-woad.vercel.app/"><img src="https://img.shields.io/badge/🌴_Live_Demo-FF6B00?style=for-the-badge&logo=vercel&logoColor=white" /></a>
&nbsp;
<a href="https://github.com/salonyranjan/GTA-VI/issues/new"><img src="https://img.shields.io/badge/💡_Feature_Request-88CE02?style=for-the-badge&logoColor=black" /></a>

<br/><br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:88CE02,40:FFD700,75:FF6B00,100:000000&height=130&section=footer&animation=fadeIn" />

<br/>

*Recreated with* ❤️ *by* [**Salony Ranjan**](https://github.com/salonyranjan) &nbsp;·&nbsp; *© 2026 GTA VI Landing · MIT*

<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&weight=600&size=13&duration=4000&pause=1000&color=88CE02&center=true&vCenter=true&width=560&lines=SYSTEM+STATUS%3A+CINEMATIC+ENGINE+ONLINE+🌴;SCROLL-TRIGGER%3A+ACTIVE+%7C+60+FPS+⚡;STAY+SHARP+·+ANIMATE+·+SHIP" />

<img src="https://komarev.com/ghpvc/?username=salonyranjan&label=PROFILE+VIEWS&color=88CE02&style=for-the-badge" />
